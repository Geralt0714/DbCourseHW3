This is a simple book renting system involving interactions with database.
...
Please note that I did not check whether the session is geniune and active at checkout. The hyperlink that created to be used for checkout is not safe in network security sense. I believe that there is no requirement of network security in this assignment from the problem description so I did not design the security stuff.